        ...
        <div className="flex m-auto w-2/3 justify-between items-start 0 -mt-11">
                ...
                <div className="border-b pb-7 mb-7">
                  <div className="flex">
                    ...
                    <div className="ml-10 w-5/6">
                      ...
                      <div className="mt-5">
                        <p className="text-lg font-light">The Greek restaurant's service was top-notch and made our experience even better. I was impressed by the quality of the ingredients used in the Greek restaurant's dishes.</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="w-[28%] relative text-reg">
            <div className="fixed w-[17%] bg-white rounded p-3 shadow">
              ...
              <div className="mt-5">
                <button className="bg-red-600 rounded text-white px-4 font-bold w-full h-10">Find a Time</button>
              </div>
            </div>
          </div>
          {/* RESERVATION CARD PORTION */}
